...
if (isset($_POST['login_user'])) {
  ...
  if (count($errors) == 0) {
    ...
    if (mysqli_num_rows($results) == 1) {
      ...
      array_push($errors, "<div class='alert alert-warning'><b>Mauvais user/mot de passe</b></div>");
    }
  }
}
...
<div class="container-fluid">
  <a class="navbar-brand" href="index.php"><h3>GESTION GYM</h3></a>
 
</div>
</nav>
<hr>
 <h2 style="color:white; text-align:center;"> Accee Admin</h2>
 <hr>
...
<form class="form " action="" method="post">
	  ...
	  <button type="submit" class="btn btn-outline-light mb-2" name="login_user">Connection</button>
</form>
