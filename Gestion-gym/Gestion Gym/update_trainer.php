...
if (isset($_REQUEST['trainer'])) {
  ...
  $err="<div class='alert alert-success'><b>Details ENTRAINEUR MIS A JOUR</b></div>";
}
...
<div class="container">
	<form class="mt-3 form-group" method="post" action="">
		<h3>METTRE A JOUR ENTRAINEUR</h3>
		 <?php 
    echo @$err;
    ...
    ?>
		...
		<label class="mt-3">NOM TRAINER</label>
		...
		<button class="btn btn-dark mt-3" type="submit" name="trainer">METTRE A JOUR</button>
	</form>
</div>